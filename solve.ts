...
import { solveD11P1, solveD11P2 } from './src/day11';
import { solveD12P1, solveD12P2 } from './src/day12';
import { solveD20P1, solveD20P2 } from './src/day20';
...
const solve = (args: Args): Solution => {
  switch (args.day) {
    ...
    case 11:
      return run(args, solveD11P1, solveD11P2);
    case 12:
      return run(args, solveD12P1, solveD12P2);
    case 20:
      return run(args, solveD20P1, solveD20P2);
    default:
      throw new Error(
